...
function DataTable() {
  const [data, setData] = useState([
    { lastName: 'Doe', firstName: 'John', course: 'IT', birthdate: '1990-01-01' },
    { lastName: 'Smith', firstName: 'Jane', course: 'IS', birthdate: '1995-05-15' },
    { lastName: 'Brown', firstName: 'Charlie', course: 'CS', birthdate: '2000-10-10' },
    { lastName: 'Taylor', firstName: 'Emma', course: 'DS', birthdate: '1998-08-20' },
    { lastName: 'White', firstName: 'Alice', course: 'IT', birthdate: '1985-03-12' },
    { lastName: 'Black', firstName: 'Bob', course: 'IS', birthdate: '1992-02-14' },
  ]);
